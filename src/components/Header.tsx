      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-5 py-5 sm:px-8">
        ...
        <nav className="hidden flex-1 items-center justify-center gap-10 lg:flex">
          <div className="group relative py-2">
            <Link href={productsLink.href} className={`flex items-center gap-1.5 ${navClass}`}>
              {productsLink.label}
              <span className="text-[10px] transition-transform duration-200 group-hover:-rotate-180">
                ▾
              </span>
            </Link>
            <div className="invisible absolute left-1/2 top-full min-w-[180px] -translate-x-1/2 pt-3 opacity-0 transition-all duration-150 group-hover:visible group-hover:opacity-100">
