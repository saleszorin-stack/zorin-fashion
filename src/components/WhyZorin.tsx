const reasons = [
  {
    title: "Автоматизированный раскрой на Gerber",
    description:
  ...
  {
    title: "Проверенные поставщики материалов",
    description:
      "Все комплектующие закупаем у проверенных годами партнёров из Германии, Турции, Беларуси и Китая. Это даёт производству чёткие сроки поставок и предсказуемый результат.",
  },
  {
