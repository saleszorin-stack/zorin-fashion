...
const steps = [
  ...
  },
  {
    ...
    title: "Согласование",
    description:
      "Фиксируем условия сотрудничества, обсуждаем техническое задание и лекала. Если лекал и технического описания нет — разрабатываем сами, это уже входит в стоимость заказа.",
  },
  {
    n: "04",
    title: "Фурнитура и образец",
    description:
      "Подбираем фурнитуру, отшиваем опытный образец. Образец — $50 по счёту; при запуске партии в производство эта сумма засчитывается в стоимость заказа.",
    time: "2 недели",
  },
  {
    n: "05",
    ...
    description:
      "Подписываем типовой договор — сроки, объёмы и порядок расчётов фиксируются под конкретного заказчика. Вносите 50% предоплаты, на эти средства закупаются ткань и фурнитура.",
  },
  {
    n: "06",
    title: "Материалы",
  ...
  },
  {
    ...
    title: "Документы",
    description:
      "Готовим товаросопроводительные и производственные документы, предусмотренные договором; состав деклараций и сертификатов, включая СТ-1, определяем под конкретную поставку.",
  },
  {
    n: "10",
...
const terms = [
  ...
  { label: "Брак", value: "Порядок приёмки, срок предъявления претензии и способ компенсации фиксируются в договоре — замена, компенсация или иной согласованный вариант в зависимости от характера брака" },
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 sm:px-8 sm:py-20 md:grid-cols-[1.2fr_0.8fr] md:items-center">
          <div>
            ...
            <h1 className="font-serif mt-4 text-4xl font-semibold leading-[1.08] text-foreground sm:text-5xl">
              Оптовый пошив мужской одежды на заказ
            </h1>
            <p className="mt-6 max-w-xl text-base leading-relaxed text-muted">
              ZORIN — контрактное производство одежды на заказ и оптом, полный цикл,
              в Кыргызстане с 1997 года. Основные заказчики — бренды из России, оптовые компании и
        ...
        <div className="mx-auto max-w-6xl px-5 py-10 sm:px-8">
          ...
          <div className="mt-4 grid gap-8 sm:grid-cols-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted">
                Так регулярные заказчики планируют ассортимент и загрузку
                — точные производственные окна подтверждаем перед каждой
                партией.
              </p>
            </div>
            <div>
