...
export const metadata: Metadata = {
  title: "Пошив одежды на заказ — условия опта",
  description:
    "Контрактное производство и пошив одежды на заказ на фабрике ZORIN: от 300 единиц на модель одного цвета, реальный процесс из 10 шагов, коммерческие условия, что входит в стоимость.",
  keywords: [
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 sm:px-8 sm:py-20 md:grid-cols-[1.2fr_0.8fr] md:items-center">
          <div>
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-muted">
              ZORIN — контрактное производство одежды на заказ, полный цикл,
              в Бишкеке с 1997 года. Основные заказчики — бренды из России, оптовые компании и
