export const site = {
  ...
  // MAX не поддерживает ссылки по номеру телефона (в отличие от WhatsApp) —
  // нужен профиль/юзернейм из приложения. Клиент обещал прислать ссылку
  // отдельно; пока стоит ссылка на сам сервис. Заменить на max.ru/<username>,
  // как только придёт.
  max: "https://max.ru",
